...
public class AzureBlobStorageParquetWriter implements AzureBlobStorageWriter {
    ...
    public AzureBlobStorageParquetWriter(final AzureBlobStorageDestinationConfig config,
    ...
    public static Configuration getHadoopConfig(final AzureBlobStorageDestinationConfig config) {
        final Configuration hadoopConfig = new Configuration();
        hadoopConfig.set("fs.azure.account.key.%s.blob.core.windows.net".formatted(config.getAccountName()), config.getAccountKey());
        return hadoopConfig;
    }
