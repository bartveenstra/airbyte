...
public abstract class AzureDataLakeStrorageGen2DestinationAcceptanceTest extends DestinationAcceptanceTest {

  protected static final Logger LOGGER = LoggerFactory
      .getLogger(AzureDataLakeStrorageGen2DestinationAcceptanceTest.class);
  ...
  protected final AzureDalaLakeStorageGen2Format outputFormat;
  protected JsonNode configJson;
  protected AzureDataLakeStorageGen2DestinationConfig azureDataLakeStorageGen2DesitionationConfig;
  protected SpecializedBlobClientBuilder specializedBlobClientBuilder;
  protected StorageSharedKeyCredential credential;

  protected AzureDataLakeStrorageGen2DestinationAcceptanceTest(final AzureDalaLakeStorageGen2Format outputFormat) {
  ...
  protected String getImageName() {
    return "airbyte/destination-azure-data-lake-storage-gen2:dev";
  }
  ...
  protected void setup(final TestDestinationEnv testEnv) {
    ...
    configJson = Jsons.jsonNode(ImmutableMap.builder()
            .put("azure_data_lake_storage_gen2_authentication_mode", baseConfigJson.get("azure_data_lake_storage_gen2_authentication_mode"))
            .put("azure_data_lake_storage_gen2_storage_account_name", baseConfigJson.get("azure_data_lake_storage_gen2_storage_account_name"))
            .put("azure_data_lake_storage_gen2_container_name", baseConfigJson.get("azure_data_lake_storage_gen2_container_name"))
            .put("azure_data_lake_storage_gen2_base_path", baseConfigJson.get("azure_data_lake_storage_gen2_base_path"))
            .put("format", getFormatConfig())
            .build());

    this.azureDataLakeStorageGen2DesitionationConfig = AzureDataLakeStorageGen2DestinationConfig
...
//            .endpoint(azureDataLakeStorageGen2DesitionationConfig.getContainerName())
//            .credential(credential)
//            .buildClient();
//
//    final BlobContainerClient blobContainerClient = storageClient
//        .getBlobContainerClient(azureDataLakeStorageGen2DesitionationConfig.getContainerName());
//
//    if (blobContainerClient.exists()) {
//      LOGGER.info("Deleting test env: " + azureDataLakeStorageGen2DesitionationConfig.getContainerName());
